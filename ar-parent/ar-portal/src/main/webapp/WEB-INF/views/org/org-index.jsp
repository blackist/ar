							...
							<div class="col-sm-3">
								<div class="blog-item">
									<div class="blog-details">
										...
										<ul class="blog-meta">
											<li>创建于:<fmt:formatDate value="${grade.createTime}" pattern="yyyy-MM-dd"></fmt:formatDate></li>
											<li><a href="class/queryClasses.action?selectStr=${grade.gradeValue}">${grade.classNum}个班级</a></li>
										</ul>
									</div>
								</div>
							</div>
