...
<ul class="am-avg-sm-1 am-avg-md-4 am-margin am-padding am-text-center admin-content-list ">
    <li>
        <a href="info/add.action" class="am-text-warning">
            <span class="am-icon-btn am-icon-briefcase"></span><br/>发布新闻
        </a>
    </li>
    <li>
        <a href="job/createJob.action" class="am-text-success">
            <span class="am-icon-btn am-icon-file-text"></span><br/>发布招聘
        </a>
    </li>
    <li>
        <a href="origin.action" class="am-text-danger">
            <span class="am-icon-btn am-icon-recycle"></span><br/>组织管理
        </a>
    </li>
    <li>
        <a href="user.action" class="am-text-secondary">
