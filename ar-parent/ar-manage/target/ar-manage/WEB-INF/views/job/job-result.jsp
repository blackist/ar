						...
						<form class="am-form">
							<div class="am-g am-margin-top">
								<div class="am-u-sm-4 am-text-left">
									<strong>${_message}</strong> <br><hr>
									<button type="button"
										onclick="javascript:_start();location.href='job/createJob.action';"
										class="am-btn am-btn-default am-btn-block am-btn-sm">继续发布</button>
								</div>
			...
			<div class="am-margin">
				<div class="am-u-sm-10 am-text-right">
					<button type="button" class="am-btn am-btn-primary am-btn-xs"
						onclick="javascript:_start();location.href='job.action';">完成</button>
				</div>
			</div>
		</div>
		<!-- content end -->
