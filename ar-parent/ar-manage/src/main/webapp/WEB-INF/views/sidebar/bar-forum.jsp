...
<li class="admin-parent" id="bar-forum"><a class="am-cf"  href="javascript:void(0)"
	data-am-collapse="{target: '#forum-manage'}"> <span class="am-icon-file"></span>
		校友论坛管理 <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
