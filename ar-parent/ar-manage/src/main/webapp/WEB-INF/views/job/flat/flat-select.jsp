						...
						<form id="unitIdForm" class="am-form" action="job/createJob.action" method="post">
							<div class="am-g am-margin-top">
								...
								<div class="am-u-sm-4 am-text-left">
									...
									<button type="button"
										onclick="javascript:_start();location.href='flat/createFlat.action';"
										class="am-btn am-btn-default am-btn-block am-btn-sm">创建单位信息</button>
								</div>
