...
function queryDictData(pageIndex, pageSize) {
	...
	$.post("dictData/queryDictData.action", {
		"pageIndex" : pageIndex,
		"pageSize" : pageSize,
...
function addDictData() {
	$.AMUI.progress.start();
	$.post("dictData/addDictData.action", function(data) {
		$.AMUI.progress.done();
		$("#admin-content").html(data);
	});
}
...
function deleteDictData(id) {
	$.AMUI.progress.start();
	$.post("dictData/deleteDictData.action", {
		"id" : id
	}, function(data) {
		$.AMUI.progress.done();
		$("#admin-content").html(data);
...
function updateDictData(id) {
	$.AMUI.progress.start();
	$.post("dictData/updateDictData.action", {
		"id" : id
	}, function(data) {
		$.AMUI.progress.done();
		$("#admin-content").html(data);
